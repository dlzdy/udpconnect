...
//斐波那契和指数计算处理
public class FibRespHandler implements IMessageHandler {
	
	private final static Logger logger = LoggerFactory.getLogger(FibRespHandler.class);
	...
	public void handle(ChannelHandlerContext ctx, InetSocketAddress sender, String requestId, Object payload) {
		logger.info("receive fib_res = " + payload);
